/*
 Aplicaci�n que modifica algunos atributos de la ventana.
 */
package Ejercicio07;
...
public class FrameApp extends Frame {
    ...
    int cursores[] = {this.CROSSHAIR_CURSOR, DEFAULT_CURSOR, E_RESIZE_CURSOR, HAND_CURSOR, MOVE_CURSOR, NE_RESIZE_CURSOR, NW_RESIZE_CURSOR, N_RESIZE_CURSOR, TEXT_CURSOR,};
    int posCursor = 0;
    Color colores[] = {Color.BLACK, Color.BLUE, Color.CYAN, Color.DARK_GRAY, Color.GRAY, Color.GREEN, Color.LIGHT_GRAY, Color.MAGENTA, Color.ORANGE, Color.PINK, Color.RED};
    int posColor1 = 0;
    int posColor2 = 0;
    String fuentes[] = {"Helvetica", "TimesRoman", "Courier", " Dialog", "Arial"};
    int posLetra = 0;
    ...
    public void setupPaneles() {
        ...
        principal.add(new Label("Cambian las caracter�stica de la ventana", Label.CENTER));
            ...
            if (ev.target instanceof Button) {
                if (ev.arg.equals("MenuBar")) {
                    ...
                    if (this.getTitle().equals(tituloInicial)) {
                        this.setTitle("T�tulo Alternativo");
                    } else {
